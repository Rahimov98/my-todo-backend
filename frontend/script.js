...
const quotes = [
    "Сделай это сегодня, а не завтра! Зиёратшо JETTA!! 💪",
    "Маленькие шаги ведут к большим результатам. Азамат Махат Ганҷрез 🚀",
    "Продуктивность — это не количество дел, а их качество. Мехровар Шифу✨",
